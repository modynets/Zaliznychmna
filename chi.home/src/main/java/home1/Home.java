...
//
    ...
    public Home clicksetUpHostingNowBtn() throws InterruptedException {
    ...
    public Home clickgetYourOwnServerNowBtn() throws InterruptedException {
        webDriver.manage().window().maximize();
    ...
    public Home clickGetAVPSCloudNowBtn() throws InterruptedException {
        webDriver.manage().window().maximize();
    ...
    public Home clickStartBuildingYourSiteNowBtn() throws InterruptedException {
        webDriver.manage().window().maximize();
        Thread.sleep(3000);
...
//
    ...
    public Home clicksetUpBusinessHostingNowBtn() throws InterruptedException {
        webDriver.manage().window().maximize();
    ...
    public Home clicksetUpSSLCertificatesBtn() throws InterruptedException {
        webDriver.manage().window().maximize();
    ...
    public Home clickgetASSDVPSNowBtn() throws InterruptedException {
        webDriver.manage().window().maximize();
    ...
    public Home clickorderWordPressNowBtn() throws InterruptedException {
        webDriver.manage().window().maximize();
